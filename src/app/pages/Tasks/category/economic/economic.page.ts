...
export class EconomicPage implements OnInit {
  ...
  // Cargar tareas diarias de tipo 'daily' y categoría 'Economic'
  loadDailyTasks() {
    this.taskService
      .getTasksByCategoryAndType('Economico', 'daily')
      .subscribe((tasks) => {
        this.dailyTasks = tasks;
      });
  }

  // Cargar tareas mensuales de tipo 'monthly' y categoría 'Economic'
  loadMonthlyTasks() {
    this.taskService
      .getTasksByCategoryAndType('Economico', 'Monthly')
      .subscribe((tasks) => {
